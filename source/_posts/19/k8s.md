...
![](_v_images/20190625192151330_16832.png =800x)
...
Pod
![](_v_images/20190625211042032_22627.png =689x)
...
![pause。这个镜像是一个用汇编语言编写的、永远处于“暂停”状态的容器，解压后的大小也只有 100~200 KB 左右。](_v_images/20190627154546138_16440.png)
...
Pod模型
![](_v_images/20190628201401348_31678.png)
ReplicaSet  管理pod的升级
Deployment 操纵着ReplicaSet
![](_v_images/20190628203001899_17303.png)
``` 滚动升级
...
#### lstio
![](_v_images/20190714155344990_1773.png =768x)
![](_v_images/20190729145709710_6865.png =800x)
...
![](_v_images/20190715121453609_22802.png =800x)

APIServer 就可以继续创建这个 CronJob 对象
![Apiserver创建过程](_v_images/20190715122833914_1190.png =800x)
